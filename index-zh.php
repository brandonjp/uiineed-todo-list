...
<head>
    ...
    <meta name="version" content="1.10.0">
    ...
    <link href="public/css/style.min.css?v=1.10.0" rel="stylesheet" media="screen">
    <script>
        // 自动判断语言并切换
    ...
    <script src="public/js/i18n.js?v=1.10.0"></script>
...
<body>
    ...
    <script src="public/js/app.js?v=1.10.0"></script>
